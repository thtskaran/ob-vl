...
export function Creator() {
  ...
  const seoTitle =
    step === 'success' && result
      ? 'Your personalized Valentine is live | Obvix.io'
      : "Create a custom Valentine's page | Obvix.io"

  const seoDescription =
    step === 'success' && result
      ? `Share ${result.page.slug} with ${result.page.recipient_name ?? 'your special someone'} instantly.`
      : 'Design an interactive, custom-URL Valentine microsite powered by Obvix Labs.'

  const seoKeywords = [
    'valentines page generator',
    'custom url valentine',
